...
import { signInVIInterface } from "@/lib/implementations/models/sign-in";
import { useInitializedStatefulInteractiveModel } from "@mvc-react/stateful";
import { useSearchParams } from "next/navigation";

const SignIn = () => {
	const endpoint = useSearchParams().get("endpoint") ?? "";
			...
			<div className="flex w-full justify-center p-8 md:p-12">
				<div className="w-fit h-full flex items-center bg-white/90 shadow rounded-3xl p-12 md:p-14">
					<div className="flex flex-col gap-6 justify-center items-center md:flex-nowrap">
						...
						<button
							className="flex w-fit p-4 items-center gap-2 !rounded-lg text-white bg-gray-800 disabled:bg-gray-400"
